    ...
    <main className="mx-auto flex min-h-full w-full max-w-md flex-1 flex-col justify-center px-4 py-10">
      <div className="mb-8 text-center">
        ...
        <p className="mt-2 text-sm text-[var(--muted)]">
          Ingresá tu correo. Si hay una cuenta, administración puede darte el enlace o, en desarrollo,
          verás un enlace de prueba.
        </p>
      </div>

      <div className="ui-card p-6 md:p-8">
        <p className="ui-label mb-4">Solicitud</p>
        <ForgotPasswordForm />
      </div>
